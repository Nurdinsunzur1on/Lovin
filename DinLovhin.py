...
Bots=[mid,kimid,]
owner =["u6a19eda70ddac8030168f2ee09dbea10"]
admin = ["u6a19eda70ddac8030168f2ee09dbea10"]
wait = {
    'contact':False,
    'autoJoin':True,
              ...
              ##if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah Tertutup Kak")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can not be used outside the group")
                    else:
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Aduh kakak grupnya bermasalah")
                    cl.sendText(msg.to,"Banyak Yang Buat Ulah Nih Kak \n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u6a19eda70ddac8030168f2ee09dbea10'}
                    cl.sendMessage(msg)
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
                ...
                for i in gid:
                  ...
                  ki2.leaveGroup(i)
                if wait["lang"] == "JP":
                  cl.sendText(msg.to,"Babay Kakak")
                else:
...
#-----------------------------------------------
            elif msg.text in ["Cv say Tanggung ahh"]:
                ki.sendText(msg.to,"Lagi Tanggung 􀜁􀅔Har Har􏿿")
                ki2.sendText(msg.to,"Lagi Tanggung 􀜁􀅔Har Har􏿿")
                #ki3.sendText(msg.to,"Lagi Tanggung 􀜁􀅔Har Har􏿿")
                ...
                ki.sendText(msg.to,"Selamat datang di Group LGV")
                ki.sendText(msg.to,"Moga Betah")
#-----------------------------------------------
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                cl.sendText(msg.to,"Semua Udah Hadir Kak\nSiap Protect Group\nAman Gak Aman Yang Penting Anu")
      ...
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","woy","Woi","woi","kakak","kakak"]:
                 quote = ['Pengen nulis apa yh bingung😵😵😵😵😁😁😁😂😂😂.','Nulis anu Azalah 🤣🤣🤣']
...
#---------------------
        if op.type == 17:
          ...
          cl.sendText(op.param1, "Selamat Datang Di Grup LGV " + ">>>" + str(ginfo.name) + "<<<" + "\n" + "Founder Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName + "\n\n" + "Budayakan Baca Note !!! yah Ka 😊\nSemoga Betah Kk 😘")
